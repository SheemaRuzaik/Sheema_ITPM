...
<body id="page-top">
						...
						<%Salary salary =(Salary) request.getAttribute("salary");%>
						  ...
						  <form action="./CalculateSalary" method="post">
								...
								<div class="input-group input-group-icon">
			 						<input type="text" id="empid" name="empid" placeholder=" Employee ID" pattern="[E]+[0-9]{4}" title="EXXXX" required>
								...
								<div class="input-group input-group-icon">
				 				...
				 				<button type="submit" class="btn btn-success" style="height: 50px; width: 180px;"> Calculate </button>
							...
							<form action="./CalculateSalary" method="post">
								...
								<div class="insertsal">
									<form action="./InsertSalary" method="post">
										...
										<input type="hidden" name="attend_days" value="<%=salary.getDays() %>">
										...
										<button type="submit" class="btn btn-danger" style="height: 50px; width: 180px;"> Save Salary </button>
										<br><br>
									</form>
								</div>	
    ...
    <script type="text/javascript">
    	...
    	if(i == "Id no"){
    		...
    		alert('Sorry! No Record in That Month')
    	}else if(i == "insert"){
    		alert('Sorry! This record is already inserted');
    	}
