...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
						  ...
						  <form action="./Attendance" method="post" class="form-container">
								...
								<div class="input-group input-group-icon">
									<input type="number" name="days" id="days" min="0" max="30" placeholder="0-30" title="0 - 30" required>
									<div class="input-icon"><i class="fa fa-calendar"></i></div>
								</div>
								</div>
								</div>
								...
								<button type="submit"  onclick="noOfDays()" class="btn btn-success" style="height: 50px; width: 180px;">Enter</button>
    ...
    <script type="text/javascript">
    	...
    	if(i == "Id no"){
    		...
    		alert('Sorry! That record is already Exist');
    	}
