        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Table Start -->
					...
					<br>
					<hr style="background-color: 10px solid black;">
					<br>
					<h1 style="color: black;">Retire Employee List</h1>
					<br>
					<!-- Table Start -->
                	...
                	<table>
                    		...
                    		<%
                    			ArrayList<Employee> empy1 = new ArrayList<>();
                    		                    		                               
                    		    IPayroll ipayrolls = new PayrollImpl();
                    		                    		                                            		
                    	       empy = ipayroll.DeleteEmployee();
