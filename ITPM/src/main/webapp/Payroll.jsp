...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="Payroll.jsp">Payroll</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form action="./PayrollList" method="post">
					...
					<button type="submit" class="btn btn-success" style="height: 50px; width: 180px;"> Search </button>
				 ...
				 <%if(salary != null){ %>
				 	...
				 	<h1 style="color: black;"><%=salary.getMonth() %> Salary Payment List</h1><br><br>
		             <!-- table -->
		             <table>
		                <tr>
		                	<th>Employee ID</th>
		                ...
		                <tr>
		                	...
		                	<td><%=sal.getMonth() %></td>
		                	<td><%=sal.getStatus() %></td>
		                	<td><%=sal.getTotSalary() %></td>
		                	<td>
		                		<%if(sal.getStatus().equals("Paid")){ %>
			                    		<input type="hidden" name="salaryid" value="<%=sal.getSalaryid()%>">
			                    		<button type="submit" class="btn btn-warning" style="height: 35px; width: 80px; margin: 5px;" disabled>Paid</button>
			                    <%}else{ %>
			                		<form action="./GetPayroll" method="post">
			                    		<input type="hidden" name="salaryid" id="salaryid" value="<%=sal.getSalaryid()%>">
			                   			<button type="submit" class="btn btn-warning" style="height: 35spx; width: 80px; margin: 5px;">Pay</button>
			                    	</form>
			                    <%} %>
		                	</td>
		                </tr>
    ...
    <script type="text/javascript">
    	...
    	if(i == "no record"){
    		alert("No records in that month");
    	}
