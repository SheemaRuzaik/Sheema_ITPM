        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form action="./UpdateLeaveRequest" method="post" class="form-container">
					...
					<div class="col-half">
						...
						<div class="input-group input-group-icon">
							<input type="text" name="empid" id="empid" value="<%=leave.getEmpid()%>" readonly title="can't change">
					...
					<div class="col-half">
						...
						<div class="input-group input-group-icon">
							<input type="text" name="reason" id="reason" value="<%=leave.getReason()%>" readonly title="can't change">
					...
					<div class="col-half">
						<h4>From Date</h4>
						<div class="input-group input-group-icon">
							<input type="date" name="fromdate" id="fromdate" value="<%=leave.getFromdate()%>" readonly title="can't change">
					...
					<div class="col-half">
						<h4>To Date</h4>
						<div class="input-group input-group-icon">
							<input type="date" name="todate" id="todate" value="<%=leave.getTodate()%>" title="can change">
							<div class="input-icon"><i class="fa fa-calendar"></i></div>
						</div>
					</div>
					</div>
					...
					<div class="col-half">
						<h4>No Of Days</h4>
						<div class="input-group input-group-icon">
							<input type="number" name="days" id="days" value="<%=leave.getNoOfdays()%>" title="can change">
							<div class="input-icon"><i class="fa fa-file"></i></div>
						</div>
					</div>
					...
					<div class="col-half">
						<h4>Status</h4>
						<div class="input-group ">
						<select name="status" style="width: 425px;" title="can change">
							<option selected><%=leave.getStatus() %></option>
				...
				<form action="./DeleteLeaveRequest" method="post">
					<input type="hidden" name="leave" id="leave" value="<%=leave.getLeaveId()%>">
					<button type="submit" class="btn btn-danger" style="height: 50px; width: 220px;">Delete Leave Request</button>
				</form>
