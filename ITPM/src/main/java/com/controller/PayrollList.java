...
/**
 * Servlet implementation class PayrollList
 */
@WebServlet("/PayrollList")
public class PayrollList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ipayroll.checkSalaryTransaction(month) == false) {
			...
			summary = ipayroll.SalaryList(month);
