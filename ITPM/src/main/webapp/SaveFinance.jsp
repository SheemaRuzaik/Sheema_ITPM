...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Save Finance</h1>
                    <a href="FinanceList.jsp"><button class="btn btn-success" style="margin-left: 500px; height: 50px; width: 180px;">Finance List</button></a>
                </div>
                
                
                <br>
                <form action="./GetMonthlySalary" method="post">
					...
					<button type="submit" class="btn btn-success" style="height: 50px; width: 180px;"> View Details</button>
				...
				<form action="" method="post">
					...
					<div class="row">
						<div class="col-half">
							<h4>Salary Month</h4>
							<div class="input-group">
						 		<input type="text" id="sal_month" name="sal_month" value="<%=salary.getMonth() %>" readonly > 
						 	</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-half">
							<h4>Total Amount</h4>
							<div class="input-group">
						 		<input type="text" id="amount" name="amount" value="<%=salary.getTotSalary() %>" readonly > 
						 	</div>
						</div>
					</div>
				...
				<form action="./SendNotification" method="post">
					...
					<input type="hidden" name="salary_month" id="salary_month" value="<%=salary.getMonth()%>">
					<input type="hidden" name="amount" id="amount" value="<%=salary.getTotSalary()%>">
					
					<button type="submit" class="btn btn-danger" style="height: 50px; width: 180px;">Save</button>
    ...
    <script type="text/javascript">
    	...
    	if(i == "already"){
    		alert("Sorry! Already inserted that month records");
    	}else if(i == "no record"){
    		alert('Sorry! There are no records in that month')
    	}
    </script>
