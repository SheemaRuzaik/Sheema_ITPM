...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="ViewEmployeeLeave.jsp">Employee Leave List</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Employee Leave Request List</h1>
                    <a href="AddLeaveRequest.jsp"><button class="btn btn-success" style="margin-left: 500px; height: 50px; width: 180px;">Add Leave</button></a>
                </div>
                
                
                <%Leave leave = new Leave();
					leave = (Leave) request.getAttribute("leave");
					ArrayList<Leave> summary = new ArrayList<>();
					%>
                <!-- Search Employee -->
                <form action="./GetEmployeeLeave" method="post">
                ...
                <table>
							...
							<%
								summary = leave.getSummary();
								for(Leave leaves : summary){
							%>
								...
								<tr>
									...
									<td>
										...
										<form action="./DeleteLeaveRequest" method="post">
											<input type="hidden" name="leave" id="leave" value="<%=leaves.getLeaveId()%>">
											<button type="submit" class="btn btn-danger" style="height: 35px; width: 100px; margin: 5px;">Delete</button>
										</form>
									</td>
								</tr>
    ...
    <script type="text/javascript">
    	...
    	}else if(i == "Employee No"){
    		alert('Sorry! This Employee not get Leave');
    	}
    </script>
