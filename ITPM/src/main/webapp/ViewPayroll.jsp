            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="ViewPayroll.jsp">View Payroll</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <form action="./SalaryPayment" method="post">
					...
					<div class="input-group input-group-icon">
						<input type="text" name="empid" id="empid" value="<%=salary.getEmpid()%>" readonly>
					...
					<div class="col-half">
					<div class="input-group input-group-icon">
						<input type="month" name="month" id="month" value="<%=salary.getMonth()%>" readonly>
					...
					<div class="col-half">
					<div class="input-group input-group-icon">
						<input type="number" name="netsal" id="netsal" value="<%=salary.getTotSalary()%>" readonly>
					...
					<br>
                		<input type="hidden" name="expanse" value="<%=salary.getSalaryid() %>">
								
						<button type="submit" class="btn btn-danger" style="height: 50px; width: 100px;"> PAID </button>
